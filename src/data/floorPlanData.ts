...
export const floorPlanData = {
 ...
 waypoints: [
  // corridor
  { id: "wp_corridor_1", position: [-18, 0], connectedTo: ["wp_corridor_2"] },
  { id: "wp_corridor_2", position: [-10, 0], connectedTo: ["wp_corridor_1", "wp_corridor_3"] },
  { id: "wp_corridor_3", position: [0, 0], connectedTo: ["wp_corridor_2"] },

  // doors
  { id: "wp_door_lab7", position: [-10, 0, -2], connectedTo: ["wp_corridor_2"] },
  { id: "wp_door_lab8", position: [0, 0, -2], connectedTo: ["wp_corridor_3"] },
  { id: "wp_door_stairs", position: [5, 0, 1], connectedTo: ["wp_corridor_3"] },
],
